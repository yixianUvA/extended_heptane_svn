...
enum opt_code
{
  ...
  OPT_Wcast_align = 179,                     /* -Wcast-align */
  OPT_Wcast_qual = 180,                      /* -Wcast-qual */
  OPT_Wchar_concat = 181,                    /* -Wchar-concat */
  OPT_Wchar_subscripts = 182,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 183,           /* -Wcharacter-truncation */
  OPT_Wclobbered = 184,                      /* -Wclobbered */
  OPT_Wcomment = 185,                        /* -Wcomment */
  /* OPT_Wcomments = 186, */                 /* -Wcomments */
  OPT_Wcondition_assign = 187,               /* -Wcondition-assign */
  OPT_Wconstructor_name = 188,               /* -Wconstructor-name */
  OPT_Wconversion = 189,                     /* -Wconversion */
  OPT_Wconversion_extra = 190,               /* -Wconversion-extra */
  OPT_Wconversion_null = 191,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 192,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 193,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 194,              /* -Wctor-dtor-privacy */
  OPT_Wdeclaration_after_statement = 195,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_non_virtual_dtor = 196,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdep_ann = 197,                        /* -Wdep-ann */
  OPT_Wdeprecated = 198,                     /* -Wdeprecated */
  OPT_Wdeprecated_declarations = 199,        /* -Wdeprecated-declarations */
  OPT_Wdisabled_optimization = 200,          /* -Wdisabled-optimization */
  OPT_Wdiscouraged = 201,                    /* -Wdiscouraged */
  OPT_Wdiv_by_zero = 202,                    /* -Wdiv-by-zero */
  OPT_Wdouble_promotion = 203,               /* -Wdouble-promotion */
  OPT_Weffc__ = 204,                         /* -Weffc++ */
  OPT_Wempty_block = 205,                    /* -Wempty-block */
  OPT_Wempty_body = 206,                     /* -Wempty-body */
  OPT_Wendif_labels = 207,                   /* -Wendif-labels */
  OPT_Wenum_compare = 208,                   /* -Wenum-compare */
  OPT_Wenum_identifier = 209,                /* -Wenum-identifier */
  OPT_Wenum_switch = 210,                    /* -Wenum-switch */
  OPT_Werror = 211,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 212, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 213,                         /* -Werror= */
  OPT_Wextra = 214,                          /* -Wextra */
  OPT_Wextraneous_semicolon = 215,           /* -Wextraneous-semicolon */
  OPT_Wfallthrough = 216,                    /* -Wfallthrough */
  OPT_Wfatal_errors = 217,                   /* -Wfatal-errors */
  OPT_Wfield_hiding = 218,                   /* -Wfield-hiding */
  OPT_Wfinal_bound = 219,                    /* -Wfinal-bound */
  OPT_Wfinally = 220,                        /* -Wfinally */
  OPT_Wfloat_equal = 221,                    /* -Wfloat-equal */
  OPT_Wforbidden = 222,                      /* -Wforbidden */
  OPT_Wformat = 223,                         /* -Wformat */
  OPT_Wformat_contains_nul = 224,            /* -Wformat-contains-nul */
  OPT_Wformat_extra_args = 225,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 226,              /* -Wformat-nonliteral */
  OPT_Wformat_security = 227,                /* -Wformat-security */
  OPT_Wformat_y2k = 228,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 229,             /* -Wformat-zero-length */
  OPT_Wformat_ = 230,                        /* -Wformat= */
  OPT_Wframe_larger_than_ = 231,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 232,            /* -Wfree-nonheap-object */
  OPT_Wfunction_elimination = 233,           /* -Wfunction-elimination */
  OPT_Whiding = 234,                         /* -Whiding */
  OPT_Wignored_qualifiers = 235,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 236,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 237,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 238,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 239,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 240,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 241, */                   /* -Wimport */
  OPT_Windirect_static = 242,                /* -Windirect-static */
  OPT_Winit_self = 243,                      /* -Winit-self */
  OPT_Winline = 244,                         /* -Winline */
  OPT_Wint_to_pointer_cast = 245,            /* -Wint-to-pointer-cast */
  OPT_Wintf_annotation = 246,                /* -Wintf-annotation */
  OPT_Wintf_non_inherited = 247,             /* -Wintf-non-inherited */
  OPT_Wintrinsic_shadow = 248,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 249,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 250,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 251,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 252,                    /* -Winvalid-pch */
  OPT_Wjavadoc = 253,                        /* -Wjavadoc */
  OPT_Wjump_misses_init = 254,               /* -Wjump-misses-init */
  OPT_Wl_ = 255,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 256, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 257,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 258,                /* -Wline-truncation */
  OPT_Wlocal_hiding = 259,                   /* -Wlocal-hiding */
  OPT_Wlogical_op = 260,                     /* -Wlogical-op */
  OPT_Wlong_long = 261,                      /* -Wlong-long */
  OPT_Wmain = 262,                           /* -Wmain */
  OPT_Wmasked_catch_block = 263,             /* -Wmasked-catch-block */
  OPT_Wmaybe_uninitialized = 264,            /* -Wmaybe-uninitialized */
  OPT_Wmissing_braces = 265,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 266,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 267,     /* -Wmissing-field-initializers */
  OPT_Wmissing_format_attribute = 268,       /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 269,           /* -Wmissing-include-dirs */
  OPT_Wmissing_noreturn = 270,               /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 271,         /* -Wmissing-parameter-type */
  OPT_Wmissing_prototypes = 272,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 273,                        /* -Wmudflap */
  OPT_Wmultichar = 274,                      /* -Wmultichar */
  OPT_Wnarrowing = 275,                      /* -Wnarrowing */
  OPT_Wnested_externs = 276,                 /* -Wnested-externs */
  OPT_Wnls = 277,                            /* -Wnls */
  OPT_Wno_effect_assign = 278,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 279,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 280,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 281,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 282,                        /* -Wnonnull */
  OPT_Wnormalized_ = 283,                    /* -Wnormalized= */
  OPT_Wnull = 284,                           /* -Wnull */
  OPT_Wold_style_cast = 285,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 286,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 287,           /* -Wold-style-definition */
  OPT_Wout_of_date = 288,                    /* -Wout-of-date */
  OPT_Wover_ann = 289,                       /* -Wover-ann */
  OPT_Woverflow = 290,                       /* -Woverflow */
  OPT_Woverlength_strings = 291,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 292,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 293,                  /* -Woverride-init */
  OPT_Wp_ = 294,                             /* -Wp, */
  OPT_Wpacked = 295,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 296,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 297,                         /* -Wpadded */
  OPT_Wparam_assign = 298,                   /* -Wparam-assign */
  OPT_Wparentheses = 299,                    /* -Wparentheses */
  OPT_Wpkg_default_method = 300,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 301,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 302,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 303,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 304,            /* -Wpointer-to-int-cast */
  ...
  OPT_fexternal_blas = 560,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 561, */       /* -fexternal-templates */
  OPT_ff2c = 562,                            /* -ff2c */
  OPT_ffast_math = 563,                      /* -ffast-math */
  OPT_ffat_lto_objects = 564,                /* -ffat-lto-objects */
  ...
  OPT_ffrontend_optimize = 583,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 584,                   /* -ffunction-cse */
  OPT_ffunction_sections = 585,              /* -ffunction-sections */
  OPT_fgcse = 586,                           /* -fgcse */
  OPT_fgcse_after_reload = 587,              /* -fgcse-after-reload */
  OPT_fgcse_las = 588,                       /* -fgcse-las */
  OPT_fgcse_lm = 589,                        /* -fgcse-lm */
  OPT_fgcse_sm = 590,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 591,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 592,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 593,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 594,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 595,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 596,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 597,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 598,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 599,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 600,                     /* -fgo-prefix= */
  ...
  OPT_mabi_ = 986,                           /* -mabi= */
  OPT_mabicalls = 987,                       /* -mabicalls */
  OPT_mad = 988,                             /* -mad */
  OPT_march_ = 989,                          /* -march= */
  OPT_mbranch_cost_ = 990,                   /* -mbranch-cost= */
  OPT_mbranch_likely = 991,                  /* -mbranch-likely */
  OPT_mcheck_zero_division = 992,            /* -mcheck-zero-division */
  OPT_mcode_readable_ = 993,                 /* -mcode-readable= */
  OPT_mdebug = 994,                          /* -mdebug */
  OPT_mdebugd = 995,                         /* -mdebugd */
  OPT_mdivide_breaks = 996,                  /* -mdivide-breaks */
  OPT_mdivide_traps = 997,                   /* -mdivide-traps */
  OPT_mdmx = 998,                            /* -mdmx */
  OPT_mdouble_float = 999,                   /* -mdouble-float */
  OPT_mdsp = 1000,                           /* -mdsp */
  OPT_mdspr2 = 1001,                         /* -mdspr2 */
  OPT_meb = 1002,                            /* -meb */
  OPT_mel = 1003,                            /* -mel */
  OPT_membedded_data = 1004,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1005,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1006,                  /* -mextern-sdata */
  OPT_mfix_24k = 1007,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1008,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1009,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1010,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1011,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1012,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1013,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1014,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1015,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1016,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1017,                 /* -mfp-exceptions */
  OPT_mfp32 = 1018,                          /* -mfp32 */
  OPT_mfp64 = 1019,                          /* -mfp64 */
  OPT_mfused_madd = 1020,                    /* -mfused-madd */
  OPT_mgp32 = 1021,                          /* -mgp32 */
  OPT_mgp64 = 1022,                          /* -mgp64 */
  OPT_mgpopt = 1023,                         /* -mgpopt */
  OPT_mhard_float = 1024,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1025,              /* -minterlink-mips16 */
  OPT_mips = 1026,                           /* -mips */
  OPT_mips16 = 1027,                         /* -mips16 */
  OPT_mips3d = 1028,                         /* -mips3d */
  OPT_mllsc = 1029,                          /* -mllsc */
  OPT_mlocal_sdata = 1030,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1031,                    /* -mlong-calls */
  OPT_mlong32 = 1032,                        /* -mlong32 */
  OPT_mlong64 = 1033,                        /* -mlong64 */
  OPT_mmcount_ra_address = 1034,             /* -mmcount-ra-address */
  OPT_mmemcpy = 1035,                        /* -mmemcpy */
  OPT_mmt = 1036,                            /* -mmt */
  OPT_mno_float = 1037,                      /* -mno-float */
  OPT_mno_flush_func = 1038,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1039,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1040,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1041,                     /* -mno-mips3d */
  OPT_mpaired_single = 1042,                 /* -mpaired-single */
  OPT_mplt = 1043,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1044,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1045,               /* -mrelax-pic-calls */
  OPT_mshared = 1046,                        /* -mshared */
  OPT_msingle_float = 1047,                  /* -msingle-float */
  OPT_msmartmips = 1048,                     /* -msmartmips */
  OPT_msoft_float = 1049,                    /* -msoft-float */
  OPT_msplit_addresses = 1050,               /* -msplit-addresses */
  OPT_msym32 = 1051,                         /* -msym32 */
  OPT_msynci = 1052,                         /* -msynci */
  OPT_mtune_ = 1053,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1054,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1055,                  /* -mvr4130-align */
  OPT_mxgot = 1056,                          /* -mxgot */
  OPT_n = 1057,                              /* -n */
  OPT_no_canonical_prefixes = 1058,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1059,              /* -no-integrated-cpp */
  OPT_noasmopt = 1060,                       /* -noasmopt */
  OPT_nocpp = 1061,                          /* -nocpp */
  OPT_nodefaultlibs = 1062,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1063,                   /* -nostartfiles */
  OPT_nostdinc = 1064,                       /* -nostdinc */
  OPT_nostdinc__ = 1065,                     /* -nostdinc++ */
  OPT_nostdlib = 1066,                       /* -nostdlib */
  OPT_o = 1067,                              /* -o */
  OPT_p = 1068,                              /* -p */
  OPT_pass_exit_codes = 1069,                /* -pass-exit-codes */
  OPT_pedantic = 1070,                       /* -pedantic */
  OPT_pedantic_errors = 1071,                /* -pedantic-errors */
  OPT_pg = 1072,                             /* -pg */
  OPT_pie = 1073,                            /* -pie */
  OPT_pipe = 1074,                           /* -pipe */
  OPT_print_file_name_ = 1075,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1076,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1077,          /* -print-multi-directory */
  OPT_print_multi_lib = 1078,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1079,       /* -print-multi-os-directory */
  ...
  OPT_quiet = 1085,                          /* -quiet */
  OPT_r = 1086,                              /* -r */
  OPT_remap = 1087,                          /* -remap */
  OPT_s = 1088,                              /* -s */
  OPT_s_bc_abi = 1089,                       /* -s-bc-abi */
  OPT_save_temps = 1090,                     /* -save-temps */
  OPT_save_temps_ = 1091,                    /* -save-temps= */
  OPT_shared = 1092,                         /* -shared */
  OPT_shared_libgcc = 1093,                  /* -shared-libgcc */
  /* OPT_specs = 1094, */                    /* -specs */
  OPT_specs_ = 1095,                         /* -specs= */
  OPT_static = 1096,                         /* -static */
  OPT_static_libgcc = 1097,                  /* -static-libgcc */
  OPT_static_libgcj = 1098,                  /* -static-libgcj */
  OPT_static_libgfortran = 1099,             /* -static-libgfortran */
  OPT_static_libgo = 1100,                   /* -static-libgo */
  OPT_static_libstdc__ = 1101,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1102, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1103, */                /* -std=c++0x */
  OPT_std_c__11 = 1104,                      /* -std=c++11 */
  OPT_std_c__98 = 1105,                      /* -std=c++98 */
  OPT_std_c11 = 1106,                        /* -std=c11 */
  /* OPT_std_c1x = 1107, */                  /* -std=c1x */
  /* OPT_std_c89 = 1108, */                  /* -std=c89 */
  OPT_std_c90 = 1109,                        /* -std=c90 */
  OPT_std_c99 = 1110,                        /* -std=c99 */
  /* OPT_std_c9x = 1111, */                  /* -std=c9x */
  OPT_std_f2003 = 1112,                      /* -std=f2003 */
  OPT_std_f2008 = 1113,                      /* -std=f2008 */
  OPT_std_f2008ts = 1114,                    /* -std=f2008ts */
  OPT_std_f95 = 1115,                        /* -std=f95 */
  OPT_std_gnu = 1116,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1117, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1118, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1119,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1120,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1121,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1122, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1123, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1124,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1125,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1126, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1127, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1128,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1129, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1130, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1131, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1132,                     /* -std=legacy */
  OPT_symbolic = 1133,                       /* -symbolic */
  OPT_t = 1134,                              /* -t */
  OPT_time = 1135,                           /* -time */
  OPT_time_ = 1136,                          /* -time= */
  OPT_traditional = 1137,                    /* -traditional */
  OPT_traditional_cpp = 1138,                /* -traditional-cpp */
  OPT_trigraphs = 1139,                      /* -trigraphs */
  OPT_u = 1140,                              /* -u */
  OPT_undef = 1141,                          /* -undef */
  OPT_v = 1142,                              /* -v */
  OPT_version = 1143,                        /* -version */
  OPT_w = 1144,                              /* -w */
  OPT_wrapper = 1145,                        /* -wrapper */
  OPT_x = 1146,                              /* -x */
  OPT_z = 1147,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
