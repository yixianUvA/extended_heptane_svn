/* MDH WCET BENCHMARK SUITE. File version $Id: fir.c,v 1.1.1.1 2007-12-11 15:22:55 puaut Exp $ */
...
void 
fir_filter_int(long *in, long *out, long in_len,
	       ...
	       long scale)
{
	...
	for (i = 0; i < in_len; i++) {
	  ...
	  *out++ = (int) (acc / scale);
	  ...
	  /*
	   * if not at end, then check for startup, add to input
	   * pointer
	   */
